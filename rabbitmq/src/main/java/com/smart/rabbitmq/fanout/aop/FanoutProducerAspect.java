package com.smart.rabbitmq.fanout.aop;
...
@Component
@Aspect
public class FanoutProducerAspect {
     ...
     */
    @Pointcut(value = "execution(* com.smart.rabbitmq.fanout.producer.*.sendMessage(..))")
